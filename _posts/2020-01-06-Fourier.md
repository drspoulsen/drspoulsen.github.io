...
The kernel of the uCTFT is $$K(t,\xi) = e^{-i \xi t}$$. Fix $$\xi \in \mathbb{C}$$. For which values of $$\xi$$ does $$K(t,\xi)$$ remain bounded as $$t \rightarrow \pm \infty$$? Well, as long as $$\xi \in \mathbb{R}$$ then
