...
For the cCTFT, let $$\xi = \omega$$ and define the uCTFT of $$f$$, $${\cal F}$$, as

$${\cal F}\{f\}(\xi) := {\cal X}\{f\}(\xi).$$
...
For the cDTFT, let $$\xi = (e^{i \omega} - 1)/i$$ and define the uDTFT of $$f$$, $${\cal F}$$, as

$$
\begin{aligned}
{\cal F}\{f\}(\xi) & := \frac{1}{1+i \xi} {\cal X}\{f\}(\xi) \\
