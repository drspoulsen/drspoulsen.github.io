...
In order for the kernel to be bounded as $t \rightarrow \pm \infty,$$ it suffices that
...
![the domain for the 1,2 time scale. The domain looks almost like an ellipse.](/images/Fourier/T_12.png)
